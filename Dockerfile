...
ENV TFSRCDIR=/opt/tissue-forge
ENV TFENV=/opt/tissue-forge/package/local/linux/../../../../tissue-forge_install/env
ENV TFBUILDDIR=/opt/tissue-forge/package/local/linux/../../../../tissue-forge_build
ENV TFBUILDQUAL=local
ENV TFBUILD_CONFIG=Release
ENV TFINSTALLDIR=/opt/tissue-forge/package/local/linux/../../../../tissue-forge_install
ENV TF_WITHCUDA="1"
ENV CUDAARCHS="80;89"
...
RUN bash /opt/tissue-forge/package/local/linux/install_all.sh
RUN chown -R jovyan:users /opt/tissue-forge_install/
...
RUN conda config --append envs_dirs /opt/tissue-forge_install/env
